...
<form:form method="post" action="fetchUser" modelAttribute="user">
	<h1 class="jumbotron" HEIGHT=100>Login/Registration Page</h1>
	<h5 style="color:green" >${key}</h5>
	<table>
		<tr>
			<td>User Id :</td>
			<td><form:input path="userId" id="userId" value="" /></td>
		</tr>
...
<h5><a href="userRegistrationForm">User Registration</a></h5>
